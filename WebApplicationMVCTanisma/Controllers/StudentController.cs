    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Edit(Ogrenci ogr)
        {
            try
            {
                ...
                if (!ModelState.IsValid)    //Model geçerli olamdıysa, yeni model istenilen validasyonları sağlayamadıysa...
                {
                    return View();
                }
        ...
        public ActionResult Delete(int id)
        {
            if (id > 0)
            {
                //değişkenin adı değişecek.
                var eskiOgr = Ogrenci.OgrenciListesi.FirstOrDefault(x => x.Id == id);
            }
            return View();
        }
